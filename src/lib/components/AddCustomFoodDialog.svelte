			...
			<div class="mb-4">
				...
				<div class="relative">
					<input
						...
						class="input-touch w-full {showKhError ? 'border-red-500 dark:border-red-400' : ''}"
						required
					/>
				...
				<div class="flex gap-2">
					...
					>
						<input
							...
							class="sr-only"
						/>
						<span class="text-sm font-medium text-gray-900 dark:text-gray-100">Gramm (gr)</span>
					</label>
					<label
					...
					>
						<input
							...
							class="sr-only"
						/>
						<span class="text-sm font-medium text-gray-900 dark:text-gray-100">Milliliter (ml)</span>
					</label>
				</div>
			</div>
